...
HD_PWD='E:/Learn/FPGA/qi/04_uart/uart.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_drive.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source uart_drive.tcl -notrace
