...
HD_PWD='E:/Learn/FPGA/qi/04_uart/uart.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_drive.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_drive.tcl
