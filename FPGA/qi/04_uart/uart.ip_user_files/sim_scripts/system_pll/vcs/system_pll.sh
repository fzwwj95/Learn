...
#                script (type 'system_pll.sh -help' for more information).
#
...
reset_run()
{
  files_to_remove=(ucli.key system_pll_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc system_pll_simv.daidir vcs_lib c.obj)
