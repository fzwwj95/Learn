...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.system_pll xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.system_pll -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log system_pll_sc.so .tmp_log xcelium_lib waves.shm c.obj)
