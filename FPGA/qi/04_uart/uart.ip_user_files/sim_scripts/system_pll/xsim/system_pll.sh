...
#
# Script generated by Vivado on Mon May 26 13:28:45 +0800 2025
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : system_pll.sh
...
#
# Usage        : system_pll.sh
#                system_pll.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                system_pll.sh [-reset_run]
#                system_pll.sh [-reset_log]
#                system_pll.sh [-help]
#
...
# script info
echo -e "system_pll.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./system_pll.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot system_pll xil_defaultlib.system_pll xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim system_pll -key {Behavioral:sim_1:Functional:system_pll} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb system_pll.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./system_pll.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: system_pll.sh [-help]\n\
Usage: system_pll.sh [-step]\n\
Usage: system_pll.sh [-lib_map_path]\n\
Usage: system_pll.sh [-reset_run]\n\
Usage: system_pll.sh [-reset_log]\n\
Usage: system_pll.sh [-keep_index]\n\
Usage: system_pll.sh [-noclean_files]\n\n\
