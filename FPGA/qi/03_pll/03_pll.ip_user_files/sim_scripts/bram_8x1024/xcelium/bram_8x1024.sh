...
#                script (type 'bram_8x1024.sh -help' for more information).
#
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.bram_8x1024 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.bram_8x1024 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log bram_8x1024_sc.so .tmp_log xcelium_lib waves.shm c.obj)
