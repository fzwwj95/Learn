...
#
# Script generated by Vivado on Mon May 05 15:41:04 +0800 2025
...
#
# Usage        : bram_8x1024.sh
#                bram_8x1024.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                bram_8x1024.sh [-reset_run]
#                bram_8x1024.sh [-reset_log]
#                bram_8x1024.sh [-help]
#
...
# script info
echo -e "bram_8x1024.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./bram_8x1024.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_8 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot bram_8x1024 xil_defaultlib.bram_8x1024 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim bram_8x1024 -key {Behavioral:sim_1:Functional:bram_8x1024} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/Xilinx/2024.1/Vivado/2024.1/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb bram_8x1024.wdb xsim.dir libdpi.so)
...
Usage: bram_8x1024.sh [-step]\n\
Usage: bram_8x1024.sh [-lib_map_path]\n\
Usage: bram_8x1024.sh [-reset_run]\n\
Usage: bram_8x1024.sh [-reset_log]\n\
Usage: bram_8x1024.sh [-keep_index]\n\
